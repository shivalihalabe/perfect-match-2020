...
var requestData = async () => {
	...
	console.log("-- summary of commitment --")
	getSummary("commitment")
...
var totalWillSee = 3088;
var totalMeetFriends = 630;
var totalMeetFam = 169;
var totalMarried = 124;
var totalOneNight = 72;
...
function drawBarChart2() {
	...
	var barRelSvg = d3.select('#bar_rel')
		.append('g')
		.attr("transform", "translate(" + padding * 1.5 + "," + padding + ")");
